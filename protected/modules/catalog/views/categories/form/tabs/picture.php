<div class="row"><?php echo CHtml::image($cat->getImageUrl('preview'))?></div>
	...
	$this->widget('application.extensions.uploadify.EuploadifyWidget', 
	    array(
	        ...
	        'callbacks' => array( 
	           ...
	           'onComplete' => 'function(){$.fancybox.resize;jQuery("#uploaded_files").load("'.$this->createUrl('upload').'",{"key":'.$key.'});}',
	        )
	    ));
	?>
</div>